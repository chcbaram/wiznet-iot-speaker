...
static button_pin_t button_pin[BUTTON_MAX_CH] =
    {
        {GPIOG, GPIO_PIN_4, GPIO_PIN_RESET},  // 0. 
        {GPIOG, GPIO_PIN_3, GPIO_PIN_RESET},  // 1. 
        {GPIOG, GPIO_PIN_2, GPIO_PIN_RESET},  // 2. 
        {GPIOG, GPIO_PIN_0, GPIO_PIN_RESET},  // 3. I/O Encoder Left 
        {GPIOG, GPIO_PIN_1, GPIO_PIN_RESET},  // 4. I/O Encoder Right
    };
